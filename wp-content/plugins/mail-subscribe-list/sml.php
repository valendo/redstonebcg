...
function smlsubform($atts=array()){
	...
	$return .= '</form>';
	*/
	$return = '<form class="" method="post"><input class="sml_hiddenfield" name="sml_subscribe" type="hidden" value="1">';
	...
	if ($showname) $return .= '<p class="subscribe"><input class="input" placeholder="'.$nameholder.'" name="sml_name" type="text" value="">';
	$return .= '<input class="input" name="sml_email" placeholder="'.$emailholder.'" type="text" value="">';
	if ($showsubmit) $return .= '<input name="submit" class="btsubmit sml_submitbtn" type="submit" value="'.($submittxt?$submittxt:'Submit').'"></p>';
	$return .= '</form>';
 	return $return;
}
